...
if parte2 :
    ...
    plt.figure()
    plot_confusion_matrix(confusion_lr, complete_class_name_noLatex, title='logistic confusion matrix, double app', normalize=True)
    ...
    plt.figure()
    plot_confusion_matrix(confusion_rf, complete_class_name_noLatex, title='Random Forest confusion matrix', normalize=True)
...
if parte3 :
    ...
    a_dct_single = spy.loadmat('D:\\Top Secret\\Università\\progetto_ricerca\\scriptNew\\outputNew\\' + file_dct_single_Y)
...
if parte4 :
    ...
    write_figure(f, 'lr_initial_single_double_complete_second_test.png', caption='logistic regression, last app classified')
    f.write('\n\nResult of the KFold validation with 10 bins:')
