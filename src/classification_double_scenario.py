...
complete_class_name = ['messenger\_mess', 'messenger\_tele', 'messenger\_what', 'telegram\_mess', 'telegram\_tele', 'telegram\_what', 'whatsapp\_mess', 'whatsapp\_tele', 'whatsapp\_what', 'original']
complete_class_name_up = ['', 'messenger_mess', 'messenger_tele', 'messenger_what', 'telegram_mess', 'telegram_tele', 'telegram_what', 'whatsapp_mess', 'whatsapp_tele', 'whatsapp_what', 'original']
