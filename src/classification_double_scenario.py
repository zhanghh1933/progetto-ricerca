...
def double_scenario_classification(argv, new_method=False, extra_test=False):

    file_add = SETTINGS['double_addi']
    if new_method:
        print("uso le nuove features che ho estratto io")
        file_dct_Y = SETTINGS['double_dct_new']
    else:
        file_dct_Y = SETTINGS['double_dct']


    file_add_single = SETTINGS['single_addi']
    if new_method:
        print("uso le nuove features che ho estratto io")
        file_dct_single_Y = SETTINGS['single_dct_new']
    else:
        file_dct_single_Y = SETTINGS['single_dct']

    folder_report = SETTINGS['report_folder']
    report_image_folder = SETTINGS['report_image_folder']

    parte1 = True
    parte2 = True
    parte3 = True
    parte4 = False # non la mettiamo nel report
    ...
    a_add = spy.loadmat(file_add)
    a_dct = spy.loadmat(file_dct_Y)
    ...
    if parte1:
        ...
        f = open(folder_report + prefix + file_name, 'w')
        ...
        f.write("Starting with fitting randomly the classifiers, there are some "
                "statistics of the data used for the first test: \\\\")
        ...
        plt.figure()
        plot_confusion_matrix(confusion_lr, simple_class_name, title='logistic confusion matrix, last app',
                              normalize=True)
        plt.savefig(report_image_folder + prefix + 'lr_initial_double_simple.png')
        plt.close()
        ...
        write_figure(f, prefix +'lr_initial_double_simple.png', caption='logistic regression, last app classified')
        ...
        plt.savefig(report_image_folder + prefix + 'lsvm_initial_double_simple.png')
        plt.close()
        ...
        write_figure(f, prefix + 'lsvm_initial_double_simple.png', caption='linear SVM, last app classified')
        f.write('\n\nResult of the KFold validation with 10 bins:')
        ...
        plt.savefig(report_image_folder + prefix + 'rf_initial_double_simple.png')
        plt.close()
        ...
        write_figure(f, prefix + 'rf_initial_double_simple.png', caption='random forest, last app classified')
        f.write('\n\nResult of the KFold validation with 10 bins:')
    ...
    if parte2:
        ...
        f = open(folder_report + prefix + file_name2, 'w')
        ...
        plot_confusion_matrix(confusion_lr, complete_class_name_noLatex, title='logistic confusion matrix, double app',
                              normalize=True)
        plt.savefig(report_image_folder + prefix + 'lr_initial_double_complete.png')
        plt.close()
        ...
        write_figure(f, prefix + 'lr_initial_double_complete.png', caption='logistic regression, last app classified')
        f.write('\n\nResult of the KFold validation with 10 bins:')
        ...
        plt.savefig(report_image_folder + prefix + 'lsvm_initial_double_complete.png')
        plt.close()
        ...
        write_figure(f, prefix + 'lsvm_initial_double_complete.png', caption='linear SVM, last app classified')
        f.write('\n\nResult of the KFold validation with 10 bins:')
        ...
        plot_confusion_matrix(confusion_rf, complete_class_name_noLatex, title='Random Forest confusion matrix',
                              normalize=True)
        plt.savefig(report_image_folder + prefix + 'rf_initial_double_complete.png')
        plt.close()
        ...
        write_figure(f, prefix + 'rf_initial_double_complete.png', caption='random forest, last app classified')
        f.write('\n\nResult of the KFold validation with 10 bins:')
    ...
    if parte3:
        ...
        f = open(folder_report + prefix + file_name3, 'w')

        f.write('\n\n\\chapter{Single and double scenario, KFold Validation}\n\n')
        a_add_single = spy.loadmat(file_add_single)
        a_dct_single = spy.loadmat(file_dct_single_Y)
        ...
        plt.figure()
        plot_confusion_matrix(confusion_lr, complete_class_name_noLatex, title='logistic confusion matrix',
                              normalize=True)
        plt.savefig(report_image_folder + prefix + 'lr_initial_single_double_complete.png')
        plt.close()
        ...
        write_figure(f, prefix + 'lr_initial_single_double_complete.png', caption='logistic regression, last app classified')
        f.write('\n\nResult of the KFold validation with 10 bins:')
        ...
        plt.figure()
        plot_confusion_matrix(confusion_lsvm, complete_class_name_noLatex, title='SVM confusion matrix', normalize=True)
        plt.savefig(report_image_folder + prefix + 'lsvm_initial_single_double_complete.png')
        plt.close()
        ...
        write_figure(f, prefix + 'lsvm_initial_single_double_complete.png', caption='linear SVM, last app classified')
        f.write('\n\nResult of the KFold validation with 10 bins:')
        ...
        plot_confusion_matrix(confusion_rf, complete_class_name_noLatex, title='Random Forest confusion matrix',
                              normalize=True)
        plt.savefig(report_image_folder + prefix + 'rf_initial_single_double_complete.png')
        plt.close()
        confusion_rf = np.column_stack((np.array(complete_class_name), confusion_rf))
        confusion_rf = np.append(complete_class_name_short, confusion_rf, axis=0)
        write_matrix(f, confusion_rf)

        write_figure(f, prefix + 'rf_initial_single_double_complete.png', caption='random forest, last app classified')
        f.write('\n\nResult of the KFold validation with 10 bins:')
    ...
    if parte4:
        ...
        # non lo aggiusto perchè tanto non verra mai usato
        file_name3 = 'report_double_parte4_.tex'
        f = open(folder_report + file_name3, 'w')
        f.write('\n\n\\chapter{Single and double scenario, KFold Validation}\n\n')
        a_add_single = spy.loadmat(
            'D:\\Top Secret\\Università\\progetto_ricerca\\scriptNew\\outputNew\\' + file_add_single)
        ...
        write_figure(f, 'lsvm_initial_single_double_complete_second_test.png',
        ...
        write_figure(f, 'rf_initial_single_double_complete_second_test.png',
...
if __name__ == "__main__":
    ...
    double_scenario_classification(sys.argv[1:], method, False)
